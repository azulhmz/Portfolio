        ...
        <div>
            <table border="1">
                ...
                <?php
                    ...
                    $sql = "SELECT idpersonal, nombrepersonal, paterno, materno, nombrepuesto, idpuesto FROM personal NATURAL JOIN puestor where nombrepersonal like '$buscar' '%' or paterno like '$buscar' '%' order by idpersonal desc";
